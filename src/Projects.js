        ...
        {type === 'Roameo' && (
          <>
            <p>
              ...
              Check out the <a className="text-link" href="/Travelbook/" target="_blank" rel="noopener noreferrer">site</a>.<br />
            </p>
            <span className="text-note">
              <Accordion defaultActiveKey={null}>
                ...
                <Accordion.Collapse eventKey="0">
                  <iframe src="https://drive.google.com/file/d/18L1ZgJ-T3eef8nMnN5UGUTH73CfK8PF4/preview" width="100%" height="480" title="Roameo Demo"></iframe>
                </Accordion.Collapse>
              </Accordion>
            </span>
          </>
